  ...
  return (
    ...
    >
      <button
        ...
        className="absolute right-2 top-2 z-10 flex h-5 w-5 items-center justify-center rounded-full bg-white/10 text-white/60 opacity-0 transition hover:bg-white/20 hover:text-white group-hover:opacity-100 [div:hover>&]:opacity-100"
      >
        <svg
