---
name: code-reviewer
description: Expert code review assistant for correctness, performance, security, and style. Use this agent to review code changes, identify bugs, security vulnerabilities, performance issues, and style inconsistencies in the Python (FastAPI) + React weather application.
